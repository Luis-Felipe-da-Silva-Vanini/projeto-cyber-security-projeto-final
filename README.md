Simulando Malwares em Python: Ransomware e Keylogger
Este repositório contém uma simulação educacional de malwares em Python, focada em Ransomware e Keylogger. O objetivo é demonstrar como esses tipos de ameaças funcionam em um ambiente controlado, para fins de aprendizado em cibersegurança. Atenção: Este código é estritamente para fins educacionais. Não use em sistemas reais ou sem permissão. Sempre teste em máquinas virtuais isoladas para evitar danos.
